  ...
  return (
    <div className="relative w-full p-4">
      <input
        ...
        className="w-full h-2 bg-transparent rounded-lg cursor-pointer"
        style={{
      ...
      />
      <div
        className="w-fit bg-transparent	 absolute top-1/2 transform -translate-y-full right-0 mr-4  text-purple-600 font-medium px-2 py-1 rounded"
        style={{
