    ...
    <div className="sticky top-0 z-50">
      <header className={`sticky top-0 z-50 bg-white bg-opacity-70 backdrop-blur-lg rounded-full shadow-md min-w-[33vw] border-2 ${isMismatch ? "border-red-500" : "border-green-500"}`}>
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {
            goBack &&
            <div onClick={goBack} className="shadow-md absolute -left-20 top-1/2 transform -translate-y-1/2 bg-white font-silkscreen text-3xl h-16 w-16 rounded-full flex items-center justify-center cursor-pointer">
